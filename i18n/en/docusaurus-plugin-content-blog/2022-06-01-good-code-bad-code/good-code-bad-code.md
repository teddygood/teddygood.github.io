...
authors: teddygood
date: '2022-05-29'
description: "How Programmers Can Improve Their Code  \n(Note: The original Korean
  phrase \"프로그래머의 코드 개선법\" is concise, so the translation expands it slightly for
  natural English flow while retaining the core meaning.)  \n\nIf a word-for-word
  translation is strictly required:  \n**\"A Programmer's Method for Code Improvement\"**
  \ \n\nLet me know if you'd like a specific tone (e.g., technical, casual) or context!"
draft: false
keywords:
- Java
- Test code
...
tags:
- Book Review
title: "\U0001F4D6Good Code, Bad Code"
---
...
[![Book](../assets/review/good-code-bad-code.jpg)](https://www.kyobobook.co.kr/product/detailViewKor.laf?ejkGb=KOR&mallGb=KOR&barcode=9791191600896&orderClick=LEa&Kc=)

- Title: *Good Code, Bad Code*  
- Author: Tom Long  
- Translator: Gunhee Cha  
- Publisher: Jpub  
